...
async def start(message: types.Message):
    ...
    await message.answer(
        ...
        '\n'
        '<b>Доставка й оплата:</b> Нова Пошта по Україні. Укрпошта — за попереднім узгодженням. Доставку оплачує покупець за тарифами служби доставки. Відправляємо після оплати протягом 1–2 робочих днів. Оплата — через Monobank у Mini App.\n'
        '\n'
        '<b>Повернення:</b> згідно із законодавством України, продовольчі товари належної якості поверненню й обміну не підлягають. Якщо товар пошкодився під час транспортування, зв’яжіться з нами для компенсації.',
        reply_markup=kb,
    )
